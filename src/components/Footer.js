  ...
  return (
    <div>
      <div className="position-relative mt-5 text-start px-5 ms-5 mb-5 ">
        ...
        <h3>
          <i className="fa-regular fa-envelope text-secondary"></i> Subscribe to
          Newsletter
        </h3>
        <Form>
          <Row>
            ...
            <Col>
              <Button variant="success" className="px-4 p-2">
                <i className="fa-brands fa-telegram fs-4 p-2"></i>
              </Button>
            </Col>
          </Row>
        </Form>
      ...
      <Container className="text-start mt-5 py-5">
        ...
        <div className="d-flex">
          <div className="p-2 flex-grow-1">
            <ul className="list-unstyled">
              <li>
                Copyright &copy; 2024. All Rights Reserved. — Designed with love
                by Untree.co
              </li>
              <li>Created by Sarika Kore</li>
            </ul>
          </div>
          <div className="p-2">
