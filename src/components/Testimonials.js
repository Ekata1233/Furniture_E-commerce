...
function Testimonials() {
  return (
    <div className='bg-body-tertiary text-center py-5'>
      ...
      <Carousel className=' '>
      <Carousel.Item>
        <p className='w-75 mx-auto fs-5 p-5 d-block'>“Donec facilisis quam ut purus rutrum lobortis. Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate velit imperdiet dolor tempor tristique. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Integer convallis volutpat dui quis scelerisque.”</p>
